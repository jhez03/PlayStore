...
class Playstore_Nav_Walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
		...
		if ( $has_children ) {
			...
			$output .= '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="var(--action-main-svg, rgb(14,13,15))">
			<path d="M8.46997 11.2402L12 14.7602L15.53 11.2402" stroke="var(--action-main-svg, rgb(14,13,15))" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
			</svg>';
			$output .= '</button>';
		}
	}
